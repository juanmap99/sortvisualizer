...
@Component({
  selector: 'app-selection-s-modal',
  templateUrl: './selection-s-modal.component.html',
  styleUrls: ['./selection-s-modal.component.css']
})
export class SelectionSModalComponent {
